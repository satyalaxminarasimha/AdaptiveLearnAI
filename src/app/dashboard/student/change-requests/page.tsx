    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Request changes to your profile details</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Request the administrator to update your profile details.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-2">
                ...
                <Select value={requestType} onValueChange={setRequestType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="details_change">Details Change</SelectItem>

            ...
            <div className="grid gap-3">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                ...
                <div>
                  ...
                  <p className="font-medium font-mono">{currentUser.rollNo}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                ...
                <div>
                  ...
                  <p className="font-medium">{currentUser.batch}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                ...
                <div>
                  ...
                  <p className="font-medium">{session?.section || currentUser.section || 'Not assigned'}</p>
                </div>
              </div>
